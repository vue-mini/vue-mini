...
- `markRaw` 标记的数据现在可以选择跳过深度拷贝

# 1.3.0-rc.2 (2026-08-02)

### 弃用

- `definePage()` 现在已不被推荐使用，请使用 `defineComponent()` 定义页面

### 新特性

- `provide()` 现在会返回一个删除函数，用于从全局仓库中删除提供的依赖项

### Bug 修复

- 修复 `onUnload()` 在页面组件中不生效的问题
...
- **@vue/reactivity:** 从 3.5.41 升至 3.5.43，详情请看 [Vue 更新日志](https://github.com/vuejs/core/blob/main/CHANGELOG.md) ([3812363](https://github.com/vue-mini/vue-mini/commit/3812363d64c03fc1c90216557c74a99b0bd9f015))

# 1.2.15 (2026-08-06)

### 依赖

- **@vue/reactivity:** 从 3.5.40 升至 3.5.41，详情请看 [Vue 更新日志](https://github.com/vuejs/core/blob/main/CHANGELOG.md) ([4068103](https://github.com/vue-mini/vue-mini/commit/4068103f3609b33a9892d040c0ee363e24996e5d))

# 1.2.14 (2026-07-18)

### 依赖

- **@vue/reactivity:** 从 3.5.39 升至 3.5.40，详情请看 [Vue 更新日志](https://github.com/vuejs/core/blob/main/CHANGELOG.md) ([dba795d](https://github.com/vue-mini/vue-mini/commit/dba795d5eaceac5748e997c172409da52efe731b))
...
- 重命名内部字段以避免与微信小程序运行时冲突 ([8941905](https://github.com/vue-mini/vue-mini/commit/8941905cefefba7f5a8ae71bb541821b9ac5f3d2)), closes [#151](https://github.com/vue-mini/vue-mini/issues/151)
...
- **@vue/reactivity:** 从 3.5.25 升至 3.5.29，详情请看 [Vue 更新日志](https://github.com/vuejs/core/blob/main/CHANGELOG.md) ([f706bf1](https://github.com/vue-mini/vue-mini/commit/f706bf1ceef6e83217d8f5736b53b4847ba5965a))

# 1.2.8 (2025-11-24)

### 依赖

- **@vue/reactivity:** 从 3.5.24 升至 3.5.25，详情请看 [Vue 更新日志](https://github.com/vuejs/core/blob/main/CHANGELOG.md) ([99065fd](https://github.com/vue-mini/vue-mini/commit/99065fd55ee5b4be589cb6f32be092e6253fff44))

# 1.2.7 (2025-11-13)

### 依赖

- **@vue/reactivity:** 从 3.5.22 升至 3.5.24，详情请看 [Vue 更新日志](https://github.com/vuejs/core/blob/main/CHANGELOG.md) ([6977d57](https://github.com/vue-mini/vue-mini/commit/6977d575c54637ecce7097ae96dc980b9a0d62bc))
